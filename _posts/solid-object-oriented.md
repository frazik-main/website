...
This acronym was coined by *Robert C. Martin* (also known as Uncle Bob). According to him, these principles form the backbone of robust object-oriented design. You can read more about these principles in his book, *\"Agile Software Development: Principles, Patterns, and Practices\"*. I will describe these principles in detail in following posts, of course, in a timely manner. :)
