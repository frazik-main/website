...
In SQL, you don't need to implement _how_ to calculate grouping or other operations; you simply describe your expectation (what you want to achieve). The Stream API in Java 8 is guided by the same philosophy.
